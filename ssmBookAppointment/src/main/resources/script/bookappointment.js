...
verifyWithDatabase:function(studentId,password){
    ...
    detail:{
        ...
        init:function(params){
            ...
            if(!studentId || !password){
                //设置弹出属性
                var IdAndPasswordModal=$('#varifyModal');   //jQuery选择器，即获取id为varifyModal的元素
                ...
                $('#studentBtn').click(function(){
                    ...
                    if(temp=="nothing"){
                        ...
                        $('#studentMessage').hide().html('<label class="lable label-danger">格式不正确</label>').show(300);
                        ...
                        //将学号和密码保存在cookie中，不设置session模式，关闭浏览器就不保存密码了
