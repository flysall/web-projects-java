...
public class QuestionComment {
	...
	public String toString() {
		return "QuestionComment [questionCommentId=" + questionCommentId + ", questionCommentContent="
				+ questionCommentContent + ", likedCount=" + likedCount + ", createTime=" + createTime + ", atUserId="
				+ atUserId + ", atUserName=" + atUserName + ", questionId=" + questionId + ", userId=" + userId
				+ ", likeState=" + likeState + "]";
	}
}